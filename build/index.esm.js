...
import { getDate, isToday, format, isSameMonth, startOfMonth, subMonths, addMonths, startOfWeek, endOfWeek, addWeeks, endOfMonth, differenceInCalendarWeeks, differenceInCalendarMonths, isAfter, isBefore, eachDayOfInterval, lightFormat, startOfDay, differenceInDays, set, isSameDay, isValid, parse } from 'date-fns';
...
function CalendarNavigation(_ref) {
  ...
  var handleYearClick = function handleYearClick(event) {
    onYearClick();
    event.preventDefault();
  ...
  }, /*#__PURE__*/React.createElement("span", null, format(month, 'LLLL', {
    locale: locale
  })), /*#__PURE__*/React.createElement("span", {
    className: "nice-dates-navigation_current_year",
    onClick: handleYearClick,
    onTouchEnd: handleYearClick
  }, format(month, 'yyyy', {
    locale: locale
  }))), /*#__PURE__*/React.createElement("a", {
...
var isValidYear = function isValidYear(year, _ref4) {
  var minimumDate = _ref4.minimumDate,
      maximumDate = _ref4.maximumDate;
  if (!minimumDate && !maximumDate) return true;
  var minYear = minimumDate ? new Date(minimumDate).getFullYear() : 1900;
  var maxYear = maximumDate ? new Date(maximumDate).getFullYear() : 2099;
...
function CalendarYearSelection(_ref) {
  var _this = this;
  ...
  var minYear = 1900;
  var maxYear = 2099;
  var currentFullYear = new Date(year).getFullYear();
  ...
  var currentYearRef = useRef(null);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var isCurrentYear = currentFullYear === y;
    return /*#__PURE__*/React.createElement("div", {
      key: y,
      ref: isCurrentYear ? currentYearRef : null,
      onClick: handleYearClick.bind(_this, y),
      onTouchEnd: handleYearClick.bind(_this, y),
      className: classnames('nice-dates-year_item', {
        '-current-year': isCurrentYear,
        '-disabled': !isValidYear(y, {
...
function Calendar(_ref) {
  ...
  var _useState = useState(false),
      _useState2 = _slicedToArray(_useState, 2),
      isSelectYear = _useState2[0],
      setIsSelectYear = _useState2[1];
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CalendarNavigation, {
    ...
    touchDragEnabled: touchDragEnabled
  }), /*#__PURE__*/React.createElement(CalendarYearSelection, {
    minimumDate: minimumDate,
    maximumDate: maximumDate,
    show: isSelectYear,
    year: month,
